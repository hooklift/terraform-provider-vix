...
* In Github, fork `https://github.comcloudescape/terraform-provider-vix` to your own account
* Get the package using "go get": `go get github.com/cloudescape/terraform-provider-vix`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/cloudescape/terraform-provider-vix`
